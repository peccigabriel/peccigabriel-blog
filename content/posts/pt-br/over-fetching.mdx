...
description: "O que é over-fetching, por que ele degrada a performance da sua aplicação de forma silenciosa e como identificá-lo e evitá-lo em contratos de API."
